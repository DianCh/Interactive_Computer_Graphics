...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_G : on_actionSave_Image_triggered(); break;

    // Load 2D json and rasterize
    case Qt::Key_B : on_actionLoad_Scene_triggered(); break;

    // Load 3D obj and rasterize
    case Qt::Key_Space : on_watch_3D(); break;

    // Interactive camera for 3D case
    case Qt::Key_W : myCamera.moveForward(0.5); break;
    case Qt::Key_A : myCamera.moveRight(-0.5); break;
    case Qt::Key_S : myCamera.moveForward(-0.5); break;
    case Qt::Key_D : myCamera.moveRight(0.5); break;
    case Qt::Key_E : myCamera.moveUp(0.5); break;
    case Qt::Key_Q : myCamera.moveUp(-0.5); break;

    case Qt::Key_I : myCamera.pitchX(-2.5); break;
    case Qt::Key_J : myCamera.yawY(2.5); break;
    case Qt::Key_K : myCamera.pitchX(2.5); break;
    case Qt::Key_L : myCamera.yawY(-2.5); break;
    case Qt::Key_U : myCamera.rollZ(-2.5); break;
    case Qt::Key_O : myCamera.rollZ(2.5); break;

    }

    //rendered_image = rasterizer.RenderScene3D(myCamera);
