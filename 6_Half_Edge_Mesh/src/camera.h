...
public:
    ...
    Camera(unsigned int w, unsigned int h, const glm::vec3 &e, const glm::vec3 &r, const glm::vec3 &worldUp, const glm::vec3 &worldRight);
    ...
    void RotateAboutX(float deg);       // New feature added in hw7; rotate around the X axis in world space
    void RotateAboutY(float deg);       // New feature added in hw7; rotate around the Y axis in world space
};
