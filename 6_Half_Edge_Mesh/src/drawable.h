...
protected:
    ...
    GLuint bufIDs;      // New feature in hw8; VBO for IDs of bind matrices
    GLuint bufWeights;  // New feature in hw8; VBO for weights of transformations

    bool idxBound; // Set to TRUE by generateIdx(), returned by bindIdx().
    bool posBound;
    bool norBound;
    bool colBound;
    bool IDsBound;      // New feature in hw8
    bool weightsBound;  // New feature in hw8
...
public:
    ...
    void generateNor();
    void generateCol();
    void generateIDs();         // New feature in hw8
    void generateWeights();     // New feature in hw8

    bool bindIdx();
    bool bindPos();
    bool bindNor();
    bool bindCol();
    bool bindIDs();             // New feature in hw8
    bool bindWeights();         // New feature in hw8
};
