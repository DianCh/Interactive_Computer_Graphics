...
public:
    ...
    // pass the screen dimension to this shader on the GPU
    ...
    void setTime(int t);             // New feature added in milestone 2
    void setEyePos(glm::vec4 pos);   // New feature added in milestone 2

    QString qTextFileRead(const char*);

    void setTickingFlag(int f);      // New feature added in milestone 3
    void setDeformWater(int dw);     // New feature added in milestone 3
    void setDeformLava(int dl);      // New feature added in milestone 3
